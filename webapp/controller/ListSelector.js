sap.ui.define([
		...
		return BaseObject.extend("smartform.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias smartform.model.ListSelector
			 */
			 ...
			 * @return {smartform.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
